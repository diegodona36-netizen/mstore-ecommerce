...
export const BentoGrid = ({ onSelectCategory, isLightBg = false }) => {
  ...
  return (
    <section id="bento" className="space-y-12 py-4">
      
      {/* 1. SECCIÓN SOYTECHNO STYLE: CATEGORÍAS INNOVADORAS */}
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
          <div>
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#00E5FF]/15 text-[#00E5FF] border border-[#00E5FF]/40 text-xs font-extrabold font-space uppercase">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Explora el Catálogo por Sección</span>
            </div>
            <h2 className="text-2xl sm:text-4xl font-extrabold font-space text-white tracking-tight mt-2">
              Categorías <span className="gradient-text-cyan">Innovadoras</span>
            </h2>
          </div>
          <p className="text-xs text-slate-300 font-inter max-w-sm">
            Selecciona cualquier categoría para filtrar automáticamente todo el catálogo en tiempo real.
          </p>
        </div>

        {/* Horizontal Scrollable Category Icon Grid (Estilo SoyTechno) */}
          ...
          {innovativeCategories.map((cat) => {
            ...
            return (
              <div
                ...
                className="bg-black/50 hover:bg-[#00E5FF]/10 rounded-2xl p-4 border border-white/10 hover:border-[#00E5FF]/60 transition-all duration-300 cursor-pointer group flex flex-col items-center justify-between text-center space-y-3 shadow-md hover:-translate-y-1"
              >
                {/* Image Avatar Frame */}
                <div className="relative w-16 h-16 rounded-2xl overflow-hidden bg-white/5 border border-white/10 p-2 group-hover:border-[#00E5FF] transition-all flex items-center justify-center shrink-0">
                  <img 
                    src={cat.image} 
                    alt={cat.name} 
                ...
                {/* Title */}
                <div>
                  <h4 className="text-xs font-extrabold font-space text-white group-hover:text-[#00E5FF] transition-colors leading-snug">
                    {cat.name}
                  </h4>
                  <span className="text-[9px] text-[#00E5FF] font-mono font-bold mt-1 block">
                    {cat.badge}
                  </span>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 pt-4 border-t border-white/10">
        
        {/* Card 1: Telefonía Insignia */}
        <div 
          onClick={() => onSelectCategory && onSelectCategory('smartphones')}
          className="md:col-span-2 lg:col-span-2 md:row-span-2 rounded-3xl p-8 relative overflow-hidden group cursor-pointer transition-all duration-500 min-h-[380px] flex flex-col justify-between glass-card border border-white/10 hover:border-[#00E5FF]/50"
        >
          ...
          <div className="relative z-10 pt-20">
            <h3 className="text-2xl md:text-3xl font-extrabold font-space text-white group-hover:text-[#00E5FF] transition-colors flex items-center gap-2">
              Telefonía Insignia
            ...
            <p className="text-xs sm:text-sm text-slate-300 mt-2 max-w-sm font-inter">
        ...
        <div 
          ...
          className="md:col-span-1 lg:col-span-2 rounded-3xl p-6 relative overflow-hidden group cursor-pointer transition-all duration-500 glass-card border border-white/10 hover:border-[#00E5FF]/50 flex flex-col justify-between"
        >
          <div className="flex items-center justify-between relative z-10 mb-4">
            <div className="p-3 rounded-2xl bg-[#00E5FF]/10 text-[#00E5FF] border border-[#00E5FF]/30">
              <Tv className="w-6 h-6" />
            </div>
            <span className="text-[10px] font-extrabold text-[#00E5FF] bg-[#00E5FF]/10 border border-[#00E5FF]/30 px-2.5 py-1 rounded-full font-space uppercase">
              Hogar Inteligente
            </span>
          </div>

          <div className="relative z-10">
            <h3 className="text-xl font-extrabold font-space text-white group-hover:text-[#00E5FF] transition-colors flex items-center gap-2">
              Línea Blanca & Smart Home
              <ArrowUpRight className="w-5 h-5 opacity-0 group-hover:opacity-100 transition-all text-[#00E5FF]" />
            </h3>
        ...
        <div 
          ...
          className="rounded-3xl p-6 relative overflow-hidden group cursor-pointer transition-all duration-500 glass-card border border-white/10 hover:border-[#00E5FF]/50 flex flex-col justify-between"
        >
          <div className="p-3 rounded-2xl bg-[#00E5FF]/10 text-[#00E5FF] border border-[#00E5FF]/30 w-fit mb-4">
            <Headphones className="w-6 h-6" />
          </div>

          <div>
            <h3 className="text-lg font-extrabold font-space text-white group-hover:text-[#00E5FF] transition-colors">
              Audio High-End
            </h3>
            <p className="text-xs text-slate-300 mt-1 font-inter">
