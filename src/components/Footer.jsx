...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-slate-800 bg-slate-950 relative pt-16 pb-8 overflow-hidden font-inter text-slate-300">
      
      {/* Background radial glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-slate-800/20 blur-[120px] pointer-events-none rounded-full"></div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a 
                ...
                className="w-10 h-10 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-white flex items-center justify-center transition-all duration-300 shadow-sm"
              >
            ...
            <div className="space-y-2">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded-xl px-3 py-2.5 text-xs text-white placeholder-slate-400 focus:outline-none focus:border-slate-700 min-h-[44px]"
                />
                <button
                  type="submit"
