...
export const MobileBottomNav = ({ 
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full z-50 bg-black/95 backdrop-blur-xl border-t border-neutral-800/80 py-2 px-3 font-sans text-[11px] flex md:hidden">
      <div className="grid grid-cols-4 items-center gap-1 w-full text-center">
        ...
        >
          <div className="relative">
            ...
            {cartCount > 0 && (
              <span className="absolute -top-1.5 -right-2 w-4 h-4 rounded-full bg-slate-100 text-slate-950 font-black text-[9px] flex items-center justify-center shadow-md border border-neutral-800">
                {cartCount}
              </span>
            )}
          </div>
