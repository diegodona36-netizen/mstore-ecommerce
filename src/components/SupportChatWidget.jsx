...
export const SupportChatWidget = () => {
  ...
  const handleSendToWhatsApp = (e) => {
    e.preventDefault();
    if (!message.trim()) {
      window.open('https://wa.me/584120000000?text=Hola%20M%20Store!%20Deseo%20informaci%C3%B3n%20y%20asesor%C3%ADa%20personalizada.', '_blank');
      return;
    }
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 font-inter text-left">
      
      {/* POPUP CARD CHAT WIDGET (RÉPLICA EXACTA DEL DISEÑO DE LA IMAGEN DEL USUARIO) */}
      {isOpen && (
        <div className="mb-4 w-80 sm:w-96 rounded-3xl bg-[#0A0E17]/95 border border-[#00E5FF]/40 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.9)] p-5 space-y-4 animate-fadeIn">
          ...
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-2">
            <p className="text-xs text-slate-200 leading-relaxed">
              👋 <strong className="text-white font-space">¡Hola! Bienvenido a M Store.</strong> ¿Buscas algún smartphone, TV o electrodoméstico en particular? Te asesoramos en tiempo real por WhatsApp.
            </p>
      ...
      <button
        ...
        className="relative p-4 rounded-full bg-[#00E5FF] text-black shadow-[0_0_35px_#00E5FF] hover:scale-110 active:scale-95 focus-visible:ring-2 focus-visible:ring-white transition-all flex items-center justify-center cursor-pointer group min-w-[56px] min-h-[56px] ml-auto"
